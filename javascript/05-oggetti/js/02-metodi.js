/*
    I metodi di un oggetto sono funzioni che sono associate a quell'oggetto. Questi metodi possono essere utilizzati per eseguire operazioni specifiche relative all'oggetto stesso. Vengono definiti come parte dell'oggetto e possono accedere alle proprietà dell'oggetto.

    I metodi possono essere definiti direttamente nell'oggetto usando la notazione a oggetto.

    THIS
    La parola chiave this è un "oggetto contestuale", cioè rappresenta il contesto nel quale il codice in cui si trova viene eseguito. All'interno di un oggeto creato da noi, farà riferimento all'oggetto stesso. Quindi il suo valore cambia in base a dove viene usata. Per esempio, se usata in contesto globale, farà riferimento all'oggetto globale, che nel caso di un browser è la window.
*/
let user = {
    nome: 'Mario',
    eta: 30,
